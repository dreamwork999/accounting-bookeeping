...
namespace AccountingBookkeeping.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<AccountingBookkeeping.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<AccountingBookkeeping.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(AccountingBookkeeping.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(AccountingBookkeeping.Server.Models.ApplicationUser user)
        {
            try
            {
