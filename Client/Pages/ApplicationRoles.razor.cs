...
namespace AccountingBookkeeping.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<AccountingBookkeeping.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(AccountingBookkeeping.Server.Models.ApplicationRole role)
        {
            try
            {
