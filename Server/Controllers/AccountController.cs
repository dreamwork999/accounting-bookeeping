...
namespace AccountingBookkeeping.Server.Controllers
{
    ...
    public partial class AccountController : Controller
    {
        ...
        {
            string sendGridApiKey = "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";
            ...
            {
                From = new EmailAddress("no-reply@bluestoneid.com", "test"),
                Subject = subject,
                PlainTextContent = "",
                HtmlContent = "<a href=\"https://localhost/123\">Please confirm your password reset.</a>"
            };
